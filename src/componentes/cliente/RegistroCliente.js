              ...
              <div className="flex flex-col space-y-1 relative">
                    ...
                    <div className="flex items-start space-x-4">
                        ...
                        <input
                            ...
                            className={`pl-10 pr-2 border-2 ${formData.contrasena === formData.confirmarContrasena ? 'border-green-500' : 'border-red-500'} py-1 rounded-lg text-sm outline-none focus:border-yellow-600 w-full`}
                            required
                        />
                        </div>
                    </div>
